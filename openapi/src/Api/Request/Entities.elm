...
listEntityTxs : String -> Int -> Maybe Direction -> Maybe Int -> Maybe Int -> Maybe String -> Maybe String -> Maybe Int -> Api.Request Api.Data.AddressTxs
listEntityTxs currency_path entity_path direction_query minHeight_query maxHeight_query tokenCurrency_query page_query pagesize_query =
    Api.request
        "GET"
