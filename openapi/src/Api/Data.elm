{-
   ...
   The version of the OpenAPI document: 1.14.0dev9
...
type alias ExternalConversion =
    { conversionType : ExternalConversionConversionType
    , fromAddress : String
    , fromAmount : String
    , fromAsset : String
    , fromAssetTransfer : String
    , fromIsSupportedAsset : Bool
    , fromNetwork : String
    , toAddress : String
    , toAmount : String
    , toAsset : String
...
type ExternalConversionConversionType
    = ExternalConversionConversionTypeDexSwap
    | ExternalConversionConversionTypeBridgeTx


externalConversionConversionTypeVariants : List ExternalConversionConversionType
externalConversionConversionTypeVariants =
    [ ExternalConversionConversionTypeDexSwap
    , ExternalConversionConversionTypeBridgeTx
    ]
...
type alias RelatedAddress =
    { address : String
    , currency : String
    , relationType : RelatedAddressRelationType
    }


type RelatedAddressRelationType
    = RelatedAddressRelationTypePubkey


relatedAddressRelationTypeVariants : List RelatedAddressRelationType
relatedAddressRelationTypeVariants =
    [ RelatedAddressRelationTypePubkey
    ]


type alias RelatedAddresses =
    { nextPage : Maybe String
    , relatedAddresses : List (RelatedAddress)
    }
...
encodeExternalConversion : ExternalConversion -> Json.Encode.Value
encodeExternalConversion =
    encodeObject << encodeExternalConversionPairs


encodeExternalConversionWithTag : ( String, String ) -> ExternalConversion -> Json.Encode.Value
encodeExternalConversionWithTag (tagField, tag) model =
    encodeObject (encodeExternalConversionPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeExternalConversionPairs : ExternalConversion -> List EncodedField
encodeExternalConversionPairs model =
    let
        pairs =
            [ encode "conversion_type" encodeExternalConversionConversionType model.conversionType
            ...
            , encode "from_is_supported_asset" Json.Encode.bool model.fromIsSupportedAsset
...
stringFromExternalConversionConversionType : ExternalConversionConversionType -> String
stringFromExternalConversionConversionType model =
    case model of
        ExternalConversionConversionTypeDexSwap ->
            "dex_swap"
...
makeExternalConversionConversionTypeFromString : String -> Maybe ExternalConversionConversionType
makeExternalConversionConversionTypeFromString str =
    case str of
    "dex_swap" ->
        Just ExternalConversionConversionTypeDexSwap

    "bridge_tx" ->
        Just ExternalConversionConversionTypeBridgeTx
...
encodeExternalConversionConversionType : ExternalConversionConversionType -> Json.Encode.Value
encodeExternalConversionConversionType =
    Json.Encode.string << stringFromExternalConversionConversionType
...
encodeRelatedAddress : RelatedAddress -> Json.Encode.Value
encodeRelatedAddress =
    encodeObject << encodeRelatedAddressPairs


encodeRelatedAddressWithTag : ( String, String ) -> RelatedAddress -> Json.Encode.Value
encodeRelatedAddressWithTag (tagField, tag) model =
    encodeObject (encodeRelatedAddressPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRelatedAddressPairs : RelatedAddress -> List EncodedField
encodeRelatedAddressPairs model =
    let
        pairs =
            [ encode "address" Json.Encode.string model.address
            , encode "currency" Json.Encode.string model.currency
            , encode "relation_type" encodeRelatedAddressRelationType model.relationType
            ]
    in
    pairs

stringFromRelatedAddressRelationType : RelatedAddressRelationType -> String
stringFromRelatedAddressRelationType model =
    case model of
        RelatedAddressRelationTypePubkey ->
            "pubkey"


makeRelatedAddressRelationTypeFromString : String -> Maybe RelatedAddressRelationType
makeRelatedAddressRelationTypeFromString str =
    case str of
    "pubkey" ->
        Just RelatedAddressRelationTypePubkey
...
encodeRelatedAddressRelationType : RelatedAddressRelationType -> Json.Encode.Value
encodeRelatedAddressRelationType =
    Json.Encode.string << stringFromRelatedAddressRelationType



encodeRelatedAddresses : RelatedAddresses -> Json.Encode.Value
encodeRelatedAddresses =
    encodeObject << encodeRelatedAddressesPairs


encodeRelatedAddressesWithTag : ( String, String ) -> RelatedAddresses -> Json.Encode.Value
encodeRelatedAddressesWithTag (tagField, tag) model =
    encodeObject (encodeRelatedAddressesPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeRelatedAddressesPairs : RelatedAddresses -> List EncodedField
encodeRelatedAddressesPairs model =
    let
        pairs =
            [ maybeEncode "next_page" Json.Encode.string model.nextPage
            , encode "related_addresses" (Json.Encode.list encodeRelatedAddress) model.relatedAddresses
            ]
    in
    pairs
...
encodeTxs : Txs -> Json.Encode.Value
encodeTxs =
    encodeObject << encodeTxsPairs


encodeTxsWithTag : ( String, String ) -> Txs -> Json.Encode.Value
encodeTxsWithTag (tagField, tag) model =
    encodeObject (encodeTxsPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeTxsPairs : Txs -> List EncodedField
encodeTxsPairs model =
    let
        pairs =
            [ maybeEncode "next_page" Json.Encode.string model.nextPage
            , encode "txs" (Json.Encode.list encodeTx) model.txs
            ]
    in
    pairs
...
externalConversionDecoder : Json.Decode.Decoder ExternalConversion
externalConversionDecoder =
    Json.Decode.succeed ExternalConversion
        |> decode "conversion_type" externalConversionConversionTypeDecoder 
        ...
        |> decode "from_is_supported_asset" Json.Decode.bool 
...
externalConversionConversionTypeDecoder =
    Json.Decode.string
        |> Json.Decode.andThen
            (\value ->
                case value of
                    "dex_swap" ->
                        Json.Decode.succeed ExternalConversionConversionTypeDexSwap

                    "bridge_tx" ->
                        Json.Decode.succeed ExternalConversionConversionTypeBridgeTx
...
relatedAddressDecoder : Json.Decode.Decoder RelatedAddress
relatedAddressDecoder =
    Json.Decode.succeed RelatedAddress
        |> decode "address" Json.Decode.string 
        |> decode "currency" Json.Decode.string 
        |> decode "relation_type" relatedAddressRelationTypeDecoder 


relatedAddressRelationTypeDecoder : Json.Decode.Decoder RelatedAddressRelationType
relatedAddressRelationTypeDecoder =
    Json.Decode.string
        |> Json.Decode.andThen
            (\value ->
                case value of
                    "pubkey" ->
                        Json.Decode.succeed RelatedAddressRelationTypePubkey
...
relatedAddressesDecoder : Json.Decode.Decoder RelatedAddresses
relatedAddressesDecoder =
    Json.Decode.succeed RelatedAddresses
        |> maybeDecode "next_page" Json.Decode.string Nothing
        |> decode "related_addresses" (Json.Decode.list relatedAddressDecoder) 
...
txsDecoder : Json.Decode.Decoder Txs
txsDecoder =
    Json.Decode.succeed Txs
        |> maybeDecode "next_page" Json.Decode.string Nothing
        |> decode "txs" (Json.Decode.list txDecoder) 
