...
encodeExternalConversionsPairs model =
    let
        pairs =
            ...
            , encode "from_payment" Json.Encode.string model.fromPayment
            ...
            , encode "to_payment" Json.Encode.string model.toPayment
            ]
    in
    pairs
...
externalConversionsDecoder =
    Json.Decode.succeed ExternalConversions
        ...
        |> decode "from_payment" Json.Decode.string 
        ...
        |> decode "to_payment" Json.Decode.string 
