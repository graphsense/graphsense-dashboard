...
export default class AddressNode {
  ...
  render (root, x, y) {
    ...
    this.root.append('rect')
      ...
      .on('click', () => {
        this.clusterNode.layer.graph.dispatcher.call('selectAddress', null, [this.address.address, this.clusterNode.layer.id])
      })
  ...
  select () {
    this.root.select('rect').classed('selected', true)
  }
  deselect () {
    this.root.select('rect').classed('selected', false)
  }
}
