...
userTagToApiTag : { currency : String, cluster : Int, address : String } -> Bool -> UserTag -> Api.Data.AddressTag
userTagToApiTag { currency, address, cluster } isClusterDefiner tag =
    { abuse = tag.abuse
    , address = address
