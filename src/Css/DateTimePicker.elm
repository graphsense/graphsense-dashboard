...
stylesheet =
    let
        vars =
            ...
            , ( "edtp-day-between-background-color", Colors.datePickerSecondary )
            , ( "edtp-day-disabled-color", Colors.grey200 )
            , ( "edtp-day-disabled-background-color", "transparent" )
            , ( "edtp-day-picked-color", Colors.white )
            , ( "edtp-day-picked-background-color", Colors.datePickerPrimary )
            , ( "edtp-day-today-color", Colors.datePickerFocus )
            ...
            , ( "edtp-footer-toggle-button-color", Colors.datePickerButton )
            , ( "edtp-footer-toggle-button-background-color", "transparent" )
            , ( "edtp-footer-toggle-button-hover-color", Colors.datePickerButton )
